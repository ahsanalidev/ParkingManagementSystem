...
public class MainActivity extends AppCompatActivity {
    ...
    public void read() throws Exception{
        ...
        if(icount>0) {
            datatext.setText(String.format("%d records\n" +
                            "Established at %d / %02d / %02d% 02d:% 02d:% 02d",icount,
        ...
        datatext.setText(String.format(" %d records",taipei_parking_info.parkings.length));
