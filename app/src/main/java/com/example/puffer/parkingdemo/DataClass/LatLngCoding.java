...
public class LatLngCoding {
    ...
    //Convert WGS84 latitude, longitude, latitude, minute and second to TWD97 coordinates
    ...
    //Convert WGS84 latitude and longitude radians to TWD97 coordinates
    public String lonlat_To_twd97(double RadianLon, double RadianLat) {
        return Cal_lonlat_To_twd97(RadianLon, RadianLat);
    }

    //Convert TWD97 coordinates to WGS84 degrees, minutes and seconds string
